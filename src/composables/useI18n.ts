...
const translations: Record<Language, Translations> = {
  en: {
    hero: {
      ...
      shippingInfo:
        "Worldwide Shipping • Europe • Ukraine • Kazakhstan • Italy",
      shopNow: "Shop Now",
      followUs: "Follow Us",
    },
    prices: {
  ...
  uk: {
    hero: {
      ...
      shippingInfo:
        "Доставка по всьому світу • Європа • Україна • Казахстан • Італія",
    ...
    contact: {
      ...
      whatsapp: {
        title: "WhatsApp",
        description:
          "Спілкуйтеся з нами безпосередньо для персональних стильових порад",
        button: "Написати нам",
      },
      instagram: {
        title: "Instagram",
  ...
  it: {
    hero: {
      ...
      shippingInfo:
        "Spedizione mondiale • Europa • Ucraina • Kazakistan • Italia",
    ...
    contact: {
      ...
      whatsapp: {
        title: "WhatsApp",
        description:
          "Chatta direttamente con noi per consigli di stile personalizzati",
        button: "Scrivici",
      },
      instagram: {
        title: "Instagram",
